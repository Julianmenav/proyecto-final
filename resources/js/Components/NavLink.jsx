...
export default function NavLink({ href, active, children }) {
    return (
        <Link
            ...
            className={
                active
                    ? 'inline-flex items-center px-1 pt-1 border-b-4 border-[#AC3FFF] text-md font-medium leading-5 text-gray-900 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out'
