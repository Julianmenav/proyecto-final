            ...
            <section className="max-w-4xl m-auto mt-10">
                <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            {usersPaginator.data.map((user, id) => {
                                return (
                                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" key={id}>
                                        ...
                                        <td className="px-3 py-2 text-center max-w-lg truncate">{user.name}</td>
                                        <td className="px-3 py-2 text-center max-w-lg truncate">{user.email}</td>
                                        <td className="px-3 py-2 text-center">
