        ...
        >
            ...
            <div className='flex px-8 justify-center text-white flex-col items-center md:px-14 md:mt-4 lg:flex-row lg:mt-20 lg:gap-x-10'>
                ...
                <div className='mt-8 sm:mt-0'>
                    <div>
                        <div className='aspect-video sm:aspect-square sm:w-[500px] max-w-md xl:max-w-lg overflow-hidden rounded-xl relative shadow-sm sm:shadow-md shadow-white/30 flex items-center justify-center'>
                            ...
                            <Link href={route('picture.view', {'picture_id': lastPicture.id})}>
                                <img src={lastPicture.image_url} alt="last picture created" />
                            </Link>
                        </div>
