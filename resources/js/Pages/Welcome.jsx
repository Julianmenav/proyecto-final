        ...
        >
            ...
            <div className='flex px-8 md:px-14 justify-center text-white flex-col xl:flex-row items-center'>
                <div className='mt-3 lg:mt-16'>
                    ...
                    <div className='pt-12'>
                        <div className='aspect-video max-w-lg overflow-hidden rounded-xl relative'>
                            ...
                            <Link href={route('picture.view', {'picture_id': lastPicture.id})}>
                                <img src={lastPicture.image_url} alt="ultimaImagenCreada z-10" className='w-full -mt-16'/>
                            </Link>
                        </div>
                ...
                <div className='text-base sm:text-xl max-w-xl flex flex-col justify-center mt-6 md:mt-12'>
                    ...
                    <div className='flex flex-wrap gap-3 justify-evenly mt-8 lg:mt-12 '>
                        <PrimaryLink text="Comienza a crear" href={route('create.view')} className="bg-zinc-900 border border-white hover:bg-zinc-800 transition-all duration-300 animate-pulse"></PrimaryLink>
